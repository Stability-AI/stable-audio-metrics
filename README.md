...
- ***IMPORTANT*** – The `no-audioaudio` examples allow running the evaluations without downloading the datasets, because statistics and embeddings are already computed in `load`. Check the [example's documentation](examples/README.md).
