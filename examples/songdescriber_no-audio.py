...
kl = passt_kld(ids=sdd_ids, 
              ...
              load_ref_probabilities='load/passt_kld/stable-audio__song-describer__collectmean__reference_probabilities.pkl', 
              collect='mean')
...
fd = openl3_fd(
    ...
    load_ref_embeddings='load/openl3_fd/stable-audio__song-describer__channels2__44100__openl3music__openl3hopsize0.5__batch4.npz',
    batching=batch
)
